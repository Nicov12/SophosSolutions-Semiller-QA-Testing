...
@CucumberOptions(
		...
		features = "src/test/resources/com/sophossolutions/features/gorest_get_with_token_consult_user.feature", //ruta del archivo feature
		snippets = SnippetType.CAMELCASE
		)
public class GetGoRestConsultUserRunner {
