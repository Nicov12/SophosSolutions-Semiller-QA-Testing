...
@CucumberOptions(
		...
		features = "src/test/resources/com/sophossolutions/features/get_myapi_consult_user_created.feature", //ruta del archivo feature
		snippets = SnippetType.CAMELCASE
		)
public class GetMyApiConsultUserCreated {
